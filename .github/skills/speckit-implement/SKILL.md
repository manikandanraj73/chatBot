...
3. Load and analyze the implementation context:
   - **REQUIRED**: Read service/tasks.md for the complete task list and execution plan
   - **REQUIRED**: Read service/plan.md for tech stack, architecture, and file structure
